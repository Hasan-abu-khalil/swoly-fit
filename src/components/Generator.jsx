...
function Generator(props) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {Object.keys(WORKOUTS).map((type, typeIndex) => (
          <button
            ...
            className={
              "bg-slate-950 border px-4  py-3 rounded-lg hover:border-blue-600 duration-200 " +
      ...
      <Header
        index={"02"}
        title={"Loac on targets"}
        description={"Select the musckes judged for annihilation "}
      />
        ...
        {Object.keys(SCHEMES).map((schemes, schemeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 border  py-3 rounded-lg hover:border-blue-600 duration-200 " +
